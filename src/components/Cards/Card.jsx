...
const Cards=({data:{confirmed, recovered, deaths, lastUpdate}})=>{
  if(!confirmed){
    ...
    return(
        <div>
            <Grid container spacing={3} justify="center" >
                <Grid item component={Card}  xs={12} md={3} className={style.card1}>
                    <CardContent>
    ...
    <Typography color="textSecondary" >{new Date(lastUpdate).toDateString()}</Typography>
                ...
                <Grid item component={Card} xs={12} md={3}className={style.card2} >
                    <CardContent>
                ...
                <Grid item component={Card} xs={12} md={3} className={style.card3}>
                    <CardContent>
